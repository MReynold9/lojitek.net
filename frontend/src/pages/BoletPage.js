  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="p-2 pb-16">
        ...
        {!['bolet', 'maryaj'].includes(activeTab) && (
        ...
        {/* Bottom Section - Bank, Tiraj, Ticket Info */}
        <div className="bg-gray-100 p-2">
          {/* Bank and Tiraj */}
          <div className="flex items-center gap-2 mb-2">
            <div className="flex items-center gap-1">
              <span className="text-xs font-semibold">Bank</span>
              <select className="border border-gray-400 rounded px-2 py-1 text-xs bg-white">
                <option>#01</option>
                <option>#02</option>
                <option>#03</option>
              </select>
            </div>
            <select className="flex-1 border border-gray-400 rounded px-2 py-1 text-xs bg-white">
          ...
          <div className="text-xs mb-1">
            <span className="font-semibold">Nimewo Tikè: </span>
            <span className="text-blue-600 font-bold">#{Math.floor(Math.random() * 90000000) + 10000000}</span>
          </div>
          
          {/* Date Time */}
          <div className="text-xs mb-2">
            <span className="font-semibold">Dat ak Lè: </span>
            <span>{new Date().toLocaleString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true })}</span>
          </div>
          
          {/* Totals */}
          <div className="bg-white border-t-2 border-gray-800 px-2 py-2">
            <div className="flex justify-between">
              <div className="text-sm font-bold">Total Boul {totalBoul}</div>
              <div className="text-sm font-bold">Total Miz {totalMiz}</div>
            </div>
          </div>
        </div>
      </main>
