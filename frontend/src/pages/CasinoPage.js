    ...
    <div className="min-h-screen circuit-bg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold" data-testid="page-title">Casino</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="glass-card max-w-3xl mx-auto text-center animate-fadeIn">
          ...
          <h2 className="text-4xl font-bold mb-4" data-testid="welcome-message">Byenvini nan Casino!</h2>
          <p className="text-xl text-gray-300 mb-8">
            Administratè: <span className="text-purple-500 font-semibold">{admin?.full_name}</span>
          </p>
          ...
          <div className="space-y-4 text-left max-w-xl mx-auto">
            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
              ...
              <ul className="space-y-2 text-gray-300">
                <li>• Jwèt kazino varye (Slots, Blackjack, Roulette)</li>
                <li>• Sistèm mezi chans jis</li>
                <li>• Jesyon bank ak tranzaksyon</li>
                <li>• Rapò gayan ak pèt</li>
              </ul>
            </div>
